...
func run(ctx context.Context, args []string, stdout, stderr io.Writer) error {
	...
	for _, t := range []Test{
		...
		{Bin: "node", Args: []string{"bidi/dump.js"}},
		{Bin: "node", Args: []string{"bidi/content.js"}, Env: []string{"RUNS=10"}},
		{Bin: "node", Args: []string{"bidi/click.js"}},
		{Bin: "node", Args: []string{"bidi/magic8ball.js"}, Env: []string{"RUNS=5"}},
