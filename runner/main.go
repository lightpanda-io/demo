...
func run(ctx context.Context, args []string, stdout, stderr io.Writer) error {
	...
	for _, t := range []Test{
		...
		{Bin: "node", Args: []string{"cdp/blank_lifecycle.js"}},
		...
		{Bin: "node", Args: []string{"puppeteer/bidi/magic8ball.js"}, Env: []string{"RUNS=5"}},
		...
		{Bin: "go", Args: []string{"run", "input/main.go", "http://127.0.0.1:1234/form/get.html"}, Dir: "chromedp"},
		...
		{Bin: "node", Args: []string{"selenium/bidi/demo.js"}, Env: []string{"URL=http://127.0.0.1:1234/campfire-commerce/"}},
