...
const url = `${base}/revalidate-etag/index.html`;
...
servedFromCache = false;
response = await page.goto(url, { waitUntil: "load", timeout: 4000 });
if (servedFromCache)
...
body = await page.content();
const v1Match = body.match(/version: (\d+)/);
