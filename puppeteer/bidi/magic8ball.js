...
// The BiDi counterpart of puppeteer/magic8ball.js: page.keyboard.type and
// page.mouse.click are both input.performActions.
//
// page.type(selector) / page.click(selector) aren't used: puppeteer resolves
// selectors in its utility sandbox (script.addPreloadScript + channels), which
// the BiDi module doesn't implement yet. Focus and position come from
...
for (var run = 0; run<runs; run++) {
    ...
    await page.evaluate(() => document.querySelector('#question').focus());
    await page.keyboard.type('Will my code work?');
