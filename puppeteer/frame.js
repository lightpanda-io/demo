...
const frame1_content = await page.evaluate(() => { return window.frame1_content; });
if (frame1_content != '<p>over 9000!</p>\n') {
  console.log(frame1_content);
  throw new Error("frame content is not as expected");
}
